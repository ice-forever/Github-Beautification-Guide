...
function showJDBCCounter() {
	x = document.getElementById("page"); // 找到元素
	x.innerHTML = "<iframe align=\"center\" width=\"100%\" height=\"100%\" src=\"./JDBC-counter.html\"  frameborder=\"no\" border=\"0\" marginwidth=\"0\"marginheight=\"0\" scrolling=\"yes\"> </iframe>"; // 改变内容
}
...
function showTime(clock) {
	...
	var time = year + "年" + month + "月" + day + "日 " + week + " " + hour + ":"
			+ minu + ":" + second;
